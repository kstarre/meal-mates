...
ALTER TABLE `lunchgroups` MODIFY COLUMN `createdAt` TIMESTAMP NOT NULL;
ALTER TABLE `lunchgroups` MODIFY COLUMN `updatedAt` TIMESTAMP NOT NULL;
...
INSERT INTO users (firstName, lastName, password, email, phoneNumber, foodAllergies, dietaryRestrictions, admin)
VALUES ("Bill", "Gates", "B!llm0n", "bill@microsoft.com", 2222222222, "shellfish", "strict paleo", 0);

INSERT INTO users (firstName, lastName, password, email, phoneNumber, foodAllergies, dietaryRestrictions, admin)
VALUES ("Gordon", "Ramsey", "!t5r@w!", "chef@ramseyrestaurants.com", 1234567890, "none", "make sure it's cooked properly", 0);

INSERT INTO users (firstName, lastName, password, email, phoneNumber, foodAllergies, dietaryRestrictions, admin)
VALUES ("Michael", "Symon", "th3L@nd", "lola@cleveland.com", 2165555555, "none", "none", 0);
